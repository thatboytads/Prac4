...
def btn_guess_pressed(channel):
    ...
    try:
        while True:
            GPIO.setup(LED_value[0], cnt & 0x01) #set bit 0
            GPIO.setup(LED_value[1], cnt & 0x02)
            GPIO.setup(LED_value[2], cnt & 0x04)
            if GPIO.input(18) == 1:
                cnt += 1      
